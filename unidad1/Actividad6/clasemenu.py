...
class menu():
    ...
    def op1(self,lista,numero):
        ...
        if(viaj != -1):
            print("para el numero ingresado {} la canidad de millas es {}".format(numero,lista.total_millas()))
        else:
    ...
    def op2(self,lista,numero):
        ...
        viaj = lista.buscar(numero)
        if (viaj != -1):
            a=lista.Acum_Millas(millas,viaj)
            print("para el numero ingresado {} se le acumularan estas millas {}".format(numero,a))
        else:
            print("dato no valido")
